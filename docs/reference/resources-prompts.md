...
The project resources are read-only. If the EasyEDA bridge is unavailable, the resource returns a structured JSON payload with `not_available: true` instead of throwing.
