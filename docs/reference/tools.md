...
| `alignMode`    | `any` | Yes      |                                                                                                                                                                                                                                                                                                |
| `rotation`     | `any` | Yes      |                                                                                                                                                                                                                                                                                                |
| `frame`        | `any` | Yes      | Rotation frame. "stored" (default): use rotation verbatim. "bottom-view": reflect the rotation (360-r, normalized to 0..360) so text authored in the top-plane frame reads correctly on the flipped bottom view. Applies only to bottom-side layers (2/4/6/8/10/59); no-op on top-side layers. |
| `reverse`      | `any` | Yes      |                                                                                                                                                                                                                                                                                                |
| `expansion`    | `any` | Yes      |                                                                                                                                                                                                                                                                                                |
| `mirror`       | `any` | Yes      |                                                                                                                                                                                                                                                                                                |
| `confirmWrite` | `any` | Yes      |                                                                                                                                                                                                                                                                                                |
...
| `filePath`            | `any` | Yes      |             |
| `fileType`            | `any` | Yes      |             |
| `existingProjectUuid` | `any` | No       |             |
| `importOption`        | `any` | No       |             |
| `associateFootprint`  | `any` | No       |             |
| `associate3DModel`    | `any` | No       |             |
| `confirmWrite`        | `any` | Yes      |             |
