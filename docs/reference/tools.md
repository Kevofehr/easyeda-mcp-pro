...
| `easyeda_pcb_add_silkscreen_line`                  | `full`  | `medium` | Draw a non-electrical line on the PCB (e.g. Top/Bottom Silkscreen) for section dividers or board art — reuses the same PCB_PrimitiveLine primitive as add_track but with an empty net name, so it never appears in the netlist or ratsnest. Pass a single segment (startX/startY/endX/endY) or a connected `points` polyline for artwork (logos, outlines, glyphs). |
...
| Parameter      | Type                                  | Required | Description |
| -------------- | ------------------------------------- | -------- | ----------- |
| `shape`        | `'rect'` \| `'circle'` \| `'polygon'` | Yes      |             |
| `x`            | `number (optional)`                   | No       |             |
| `y`            | `number (optional)`                   | No       |             |
| `width`        | `number (optional)`                   | No       |             |
| `height`       | `number (optional)`                   | No       |             |
| `cx`           | `number (optional)`                   | No       |             |
| `cy`           | `number (optional)`                   | No       |             |
| `radius`       | `number (optional)`                   | No       |             |
| `points`       | `object[] (optional)`                 | No       |             |
...
| `x`            | `number`            | Yes      |             |
| `y`            | `number`            | Yes      |             |
| `holeDiameter` | `number`            | Yes      |             |
| `diameter`     | `number (optional)` | No       |             |
| `padNumber`    | `string`            | Yes      |             |
| `plated`       | `boolean`           | Yes      |             |
| `confirmWrite` | `'true'`            | Yes      |             |
...
| `x`            | `number`            | Yes      |             |
| `y`            | `number`            | Yes      |             |
| `layer`        | `number (optional)` | No       |             |
| `padNumber`    | `string`            | Yes      |             |
| `width`        | `number`            | Yes      |             |
| `height`       | `number (optional)` | No       |             |
| `rotation`     | `number`            | Yes      |             |
| `netName`      | `string (optional)` | No       |             |
| `holeDiameter` | `number (optional)` | No       |             |
| `padShape`     | `any[] (optional)`  | No       |             |
| `hole`         | `any[] (optional)`  | No       |             |
| `confirmWrite` | `'true'`            | Yes      |             |
...
> Draw a non-electrical line on the PCB (e.g. Top/Bottom Silkscreen) for section dividers or board art — reuses the same PCB_PrimitiveLine primitive as add_track but with an empty net name, so it never appears in the netlist or ratsnest. Pass a single segment (startX/startY/endX/endY) or a connected `points` polyline for artwork (logos, outlines, glyphs).
...
| `startX`       | `number (optional)`   | No       |                                                                                             |
| `startY`       | `number (optional)`   | No       |                                                                                             |
| `endX`         | `number (optional)`   | No       |                                                                                             |
| `endY`         | `number (optional)`   | No       |                                                                                             |
| `points`       | `object[] (optional)` | No       | Connected polyline for silkscreen artwork. Mutually exclusive with startX/startY/endX/endY. |
...
| `fontSize`     | `number`                      | Yes      |                                                                                                                                                                                                                                                                                                |
| `lineWidth`    | `number`                      | Yes      |                                                                                                                                                                                                                                                                                                |
| `alignMode`    | `number`                      | Yes      |                                                                                                                                                                                                                                                                                                |
| `rotation`     | `number`                      | Yes      |                                                                                                                                                                                                                                                                                                |
| `frame`        | `'stored'` \| `'bottom-view'` | Yes      | Rotation frame. "stored" (default): use rotation verbatim. "bottom-view": reflect the rotation (360-r, normalized to 0..360) so text authored in the top-plane frame reads correctly on the flipped bottom view. Applies only to bottom-side layers (2/4/6/8/10/59); no-op on top-side layers. |
| `reverse`      | `boolean`                     | Yes      |                                                                                                                                                                                                                                                                                                |
...
| `filePath`            | `string`             | Yes      |             |
| `fileType`            | `string`             | Yes      |             |
| `existingProjectUuid` | `string (optional)`  | No       |             |
| `importOption`        | `string (optional)`  | No       |             |
| `associateFootprint`  | `boolean (optional)` | No       |             |
| `associate3DModel`    | `boolean (optional)` | No       |             |
| `confirmWrite`        | `'true'`             | Yes      |             |
...
| Parameter             | Type                                | Required | Description |
| --------------------- | ----------------------------------- | -------- | ----------- |
| `board`               | `'top'` \| `'middle'` \| `'bottom'` | Yes      |             |
| `tscircuitDir`        | `string (optional)`                 | No       |             |
| `buildScript`         | `string`                            | Yes      |             |
| `existingProjectUuid` | `string (optional)`                 | No       |             |
| `zipPath`             | `string (optional)`                 | No       |             |
| `skipBuild`           | `boolean`                           | Yes      |             |
| `confirmWrite`        | `'true'`                            | Yes      |             |
...
{
  success: boolean;
  zipPath: string(optional);
  buildLog: string(optional);
  result: any(optional);
  error: string(optional);
}
```
